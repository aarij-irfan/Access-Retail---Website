...
function DesktopDropdown({ items, parentId, setActiveDropdown }: DesktopDropdownProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute top-full left-0 git add . bg-blue-950/95 backdrop-blur-md border border-blue-800/50 rounded-xl shadow-xl z-50 w-[250px] lg:w-[280px]"
    >
...
export default function ModernNavbar() {
  ...
  const [showKeyOfferings] = useState(false)
